...
// cuando importamos por defecto no hace falta poner llaves
// import EventEmitter from "./event-emitter";

// tambien podemos importar tanto por default como sin defualt 
import EventEmitter, { hola } from "./event-emitter";

console.log(hola);

// tambien podemos importar todo con un alias
// import * as ElnombreQueQueramos from "./event-emitter";

// Nos serviria cuando tenemos archivos con igual nombre y les colocamos un alias a cada uno
// import * as UsuariosAdmin from '../usuarios'
// si la funcion UsuariosAdmin tenia mas funciones dentro de ella se llamaria asi
// UsuariosAdmin.getUsuarios();
// import * as usuariosApp from '../app/usuarios'


// cuando importamos sin default si hace falta poner llaves
// import {EventEmitter} from "./event-emitter";
