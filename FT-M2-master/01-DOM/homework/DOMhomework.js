...
// let createdByID = document.getElementById("createdBy");
// createdBy.innerHTML += " Grupo 15B";
createdBy.append(" Grupo 15B");
...
function buildToDos(toDos) {
  ...
  // let toDoShell = toDos.map((todo, index) => {
  //   return buildToDo(todo, index);
  // });

  // let toDoShell = toDos.map((todo, index) => buildToDo(todo, index));
  // return toDoShell;
